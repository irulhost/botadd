...
const AhmadBot = {
    ahmadhost: {
        nama: 'yanzhost',
        cloudflare: {
            listdomain: { '1': '.whatsappp.xyz', '2': '.websaite-resmi.xyz', '3': '.resmi-vvip.xyz', '4': '.link-vvip.me', '5': '.bgshop.tech', '6': '.tang-codex.xyz' },
            zona: { '1': '1479775e142c4a1465e5a80b426062db', '2': '644a26e8a1900fd4abdd77c705c427e9', '3': 'f12eb7bda53abf50a5b85c49470fb29f', '4': '010209df8ad18e30e838db3ae5a022f4', '5': '6c80ee6bb53f10cd4c40ded76f298b39', '6': '8256830ab233ed3f56dc1fad475a2774' },
            tersedia: ['1', '2', '3', '4', '5', '6'],
            data: {
                email: 'bintang.ganz.store@gmail.com',
                apikey: '64457db83430096f7f1b39c1a3f4c25e01fcb',
            }
        },
        ip: 'ip server',
        grup: ['linkgrup@g.us']
    ...
    contoh: {
        nama: 'neverdienesia',
        cloudflare: {
            listdomain: { '1': '.2022-terbaru.xyz', '2': '.event28.my.id', '3': '.kulgar09.my.id', '4': '.resmi22.my.id', '5': '.new-2022.my.id', '6': '.terbaru70.my.id', '7': '.terbaru-2022.xyz' },
            zona: { '1': 'ff209ca2121e09fbc53a47f26a2c40a1', '2': 'c9af49196ae992989b0a667f993fc372', '3': 'b406d91b24a969bfcb1bfadaf83bb0dc', '4': '31b79388a157eaf6e11125ec2e59bd56', '5': '270248613845dfa125801289da9e6142', '6': 'e51e01d1706160ca150308145064293f', '7': '66e937fbc7fa3733d477b30f75d8bcc7' },
            tersedia: ['1', '2', '3', '4', '5', '6', '7'],
            data: {
                email: 'akhyulshop@gmail.com',
                apikey: '64457db83430096f7f1b39c1a3f4c25e01fcb',
            }
        },
        ip: '40.87.84.92',
        grup: ['120363041234315531@g.us', 'grup id']
     },
...
module.exports = kurr = async (kurr, mek) => {
    try {
        ...
        //runtime berjalan
        runi = process.uptime()
        kurr.setStatus(`Ahmad`).catch((_) => _);
